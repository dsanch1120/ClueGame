...
public class CTest_ExceptionTests {
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		board.setConfigFiles("CTest_ClueLayoutBadColumns.csv", "CTest_ClueLegend.txt", null, null);		//FIXME added two nulls as arguments
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		Board board = Board.getInstance();
		board.setConfigFiles("CTest_ClueLayoutBadRoom.csv", "CTest_ClueLegend.txt", null, null);		//FIXME added two nulls as arguments
		board.loadRoomConfig();
		board.loadBoardConfig();
	}
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		Board board = Board.getInstance();
		board.setConfigFiles("CTest_ClueLayout.csv", "CTest_ClueLegendBadFormat.txt", null, null);		//FIXME added two nulls as arguments
		board.loadRoomConfig();
	}
